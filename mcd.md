Dans un premier temps je te conseil d'utiliser Looping pour faire ton MCD (logiciel libre), sinon l'un des logiciell les plus utilisé est entreprise architect (très difficile à prendre en main).
